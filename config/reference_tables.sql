...
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, display_group_name, service_panel_code) VALUES ('lodgeObjection', 'registrationServices', 'Lodge Objection::::Заявление оспаривания права::::اعتراض::::Objection Dépôt::::::::::::Apresentar Objeção::::::::提出异议', '...::::...::::...::::...::::::::::::...::::::::...', 'x', 90, 5.00, 0.00, 0.00, 1, NULL, NULL, NULL, 'Systematic Registration::::::::التسجيل المنتظم::::::::::::::::Systematic Registration::::::::系统登记', 'newProperty');
