...
--drop table cadastre.level_config_map_layer;
...
insert into cadastre.level(id, name, structure_code, type_code, editable)
values('c03162e0-99dd-11e3-a27b-2bfeef31a969', 'Place Names', 'point', 'geographicLocator', true);
...
delete from system.config_map_layer where name = 'place-names';
insert into system.config_map_layer(name, title, type_code, active, visible_in_start, item_order, style, pojo_structure, pojo_query_name, pojo_query_name_for_select)
values('place-names', 'Places Names', 'pojo', true, true, 60, 'place_name.xml', 'theGeom:Point,label:""', 'SpatialResult.getPlaceNames','dynamic.informationtool.get_place_name');
